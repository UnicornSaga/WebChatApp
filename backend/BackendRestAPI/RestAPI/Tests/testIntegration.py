...
class UserViewSetIntegrationTests(APITestCase):
    ...
    def test_create_new_user(self):
        ...
        u = User.objects.get(email="vuongvu1208@gmail.com")
        self.assertEqual(u.email, "vuongvu@gmail.com")
    ...
    def test_fetch_user_by_email(self):
        ...
        url = "http://localhost:8000/api/users/vuongvu1208@gmail.com/"
        ...
        self.assertEqual(res.email, "vuongvu@gmail.com")
    ...
    def test_update_user_info(self):
        ...
        self.assertEqual(json.email, "vuongvu1208@gmail.com")
